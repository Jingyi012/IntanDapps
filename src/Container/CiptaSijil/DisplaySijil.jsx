...
const DisplaySijil = () =>{
    ...
    const getAppArgs = async()=>{

      console.log("hello");
      console.log(transId.appId);
      const transInfo = await indexerClient.lookupTransactionByID(transId.transId).do();
    ...
    <div>
      ...
      <br></br>
      <p>Tajuk Sijil: {tajuk.replaceAll('"','')}</p>
